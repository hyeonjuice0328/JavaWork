...
public class Class02Main {
	...
	public static void main(String[] args) {
		...
		Circle c1 = new Circle(); // Circle 인스턴스 생성 -> Circle은 생성자!!
		Circle c2 = new Circle(3);
		
		double perimeter = c1.calcPerimeter(); // 둘레값
		...
		double Rperimeter = r1.calcPerimeter();
		System.out.println("r1의 둘레 : " + Rperimeter);
		Rperimeter = r2.calcPerimeter();
		System.out.println("r2의 둘레 : " + Rperimeter);
