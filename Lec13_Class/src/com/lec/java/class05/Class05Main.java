...
public class Class05Main {
	...
	public static void main(String[] args) {
		...
		double distance = p1.distance(p2); // p1과 p2사이의 거리
		System.out.println("p1과 p2 사이의 거리 : " + distance);
		
		distance = p2.distance(p1); // p1과 p2사이의 거리
		System.out.println("p2와 p1 사이의 거리 : " + distance);
