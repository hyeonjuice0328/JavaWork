...
/*
	...
	클래스 안에 필 요한 '속성' 과 '행동' 을 멤버로 묶고
	외부에서의 '직접적인 접근을 제한'하여
	객체의 데이터 와 메소드를 은닉(hiding)하고,존재는 하나 감추는 것 
...
//		n1.num = 200; ---> num 은 private
//		The field Number.num is not visible
//		n1.name = 400; ---> name이라는 이름 없음 
