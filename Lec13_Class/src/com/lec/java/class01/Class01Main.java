...
public class Class01Main {
	...
	public static void main(String[] args) {
		...
		tv1.displayStatus(); // TV 현재 상태(tv1의 상태)
		...
		//외부클래서에서 아래와 같이 직접 사용하는 것을 금하게 설계함.
//		tv1.isPowerOn = false;
//		tv1.volume = 32;
//		tv1.channel = 100;
		...
		// 인스턴스 출력 > com.lec.java.class01.MyTV@15db9742
		System.out.println(tv2);
		
		System.out.println();
		tv1 = tv2; // tv1에 tv2를 대입
		//원래 tv1이 레퍼런싱 하면 인스턴스는 Garbage Collector 에 의해 소멸된다.(GC된다)
		tv1.displayStatus();
		tv1.powerOnOff();
		tv2.displayStatus(); // tv1 과 tv2는 현재 같은 인스턴스를 레퍼런싱하고 있다. 
