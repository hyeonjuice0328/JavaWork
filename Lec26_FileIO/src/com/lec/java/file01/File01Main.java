...
3) java.io.File : 파일 시스템의 파일정보를 얻기 위한 클래스, 디렉토리 생성 .. 
...
public class File01Main {
	...
	public static void main(String[] args) {
		...
		sc.close();
		// (System.in)의 in은 InputStream java.lang.System.in, The "standard" input stream.기본 입력 장치 
		System.out.println("hello");
		//.out. 은 PrintStream java.lang.System.out -> java.io.OutputStream - java.io.FilterOutputStream - java.io.PrintStream
