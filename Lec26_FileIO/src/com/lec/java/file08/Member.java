...
public class Member implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4564811082080172359L; //serial version id
	private String id;
	private String pw;
	transient private int num; // 0으로 초기화
	transient private boolean isExist; // false로 초기화
