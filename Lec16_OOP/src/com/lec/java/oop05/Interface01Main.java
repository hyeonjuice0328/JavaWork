...
public class Interface01Main {
	...
	public static void main(String[] args) {
		...
		TestImpl2 test2 = new TestImpl2(); // 인스턴스 생성 
		
		System.out.println(test1.MIN);
//		System.out.println(test2.MIN); > 에러 메세지 : ambiguous(모호한)
		System.out.println(TestInterface.MIN); // static은 static방법으로 사용하자 정확하게 사용위치를 정해서 입력하기 
