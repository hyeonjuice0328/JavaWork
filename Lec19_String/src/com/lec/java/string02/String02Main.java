...
public class String02Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("[2-2 ] String intern() 생성자 사용");
		
		if(str1.intern() == str4.intern()) {
			System.out.println("intern() 동일 참조");
		} else {
			System.out.println("intern() 다른곳 참조");
		}
		...
		//1. compare To : int 형으로 반환 같으면 0 다르면 1
		...
		System.out.println("compare To: " + str6.compareTo(str5));
		//2. compare To : .을 기준으로 왼쪽이 작으면 음수 왼쪽의 수가 크면 양수가 나온다. 
		
		
		str5 = "AaAa";
		str6 = "aAaA";
		//한글자씩 비교 ex. A와 a 를 비교 
		System.out.println("compare To: " + str5.compareTo(str6));
		System.out.println("compare To: " + str6.compareTo(str5));
