...
//		Matcher matcher;
		...
		System.out.println("정규표현식 예제");
			...
			while(true) {
				...
				System.out.println("쿠폰 번호를 입력해 주세요.");
				
				regex = "^([a-zA-Z]{2}-[1-9]{1}[0-9]{3}-[1-9]{1}[0-9]{2}-[a-zA-Z]{3})$";
				input = sc.nextLine();
				pat = Pattern.compile(regex);
				Matcher matcher = pat.matcher(input);
				
				checkTest(regex, input);
	...
	public static void checkTest(String regex, String input) {
