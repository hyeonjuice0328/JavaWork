...
public class Wrapper02Main {
	...
	public static void main(String[] args) {
		...
		Integer num1 = 10; // Integer.valueOf(10);  <---- auto-boxing(Wrapper class 안에서만 )
		Integer num2 = 20;
		...
		// unboxing(.intValue()) -> boxing(Integer.valueOf()) 
		...
		Long num100 = Long.valueOf(10000000000000L);
		...
		//auto-unboxing 은 내가 원하는 타입으로 가능하다. num1은 Wrapper Integer type이었으나 doubleValue()로 unboxing 해봤다. 
