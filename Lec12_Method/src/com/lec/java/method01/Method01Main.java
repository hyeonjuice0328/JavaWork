...
public class Method01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("제 이름은 조현주 입니다.");
		...
		sayAge(30);
		sayAge(16);
		com.lec.java.method01.Method01Main.sayAge(20); // 내가 만든 메소드의 풀네임도 사용가능하다.
	...
	// 메소드 이름 : sayHello
	// 매개변수 : name (매개변수가 필요 없는 경우 생략가능) 메소드 구동하는데 필요한 변수들
	/**
	 * 메소드 이름: sayHello 주어진 이름을 출력합니다.
	 * 
	 * @param name 이름
	 */
//	public static : 수식어 , void :  리턴타입X, sayHello : 만들고자하는메소드명, (String name) :자료형 매개변수명
