...
public class Method07Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(Math.round(2.7)); // 3 - long타입을 리턴

		System.out.println(Math.floor(-1.2)); // -2
		System.out.println(Math.ceil(-1.2)); // -1
		System.out.println(Math.round(-1.2)); // -1 - long타입을 리턴

		System.out.println(Math.floor(-2.8)); // -3
		System.out.println(Math.ceil(-2.8)); // -2
		System.out.println(Math.round(-2.8)); // -3 - long타입을 리턴
		...
		// 이렇게 한줄로 정리가능 System.out.println((int) (Math.random() * 45 + 1) + " ");
		...
		// 0 , 1, 2 사이에 난수 5개 발생
		for (int i = 0; i < 5; i++) {
			System.out.print(rand.nextInt(3) + ", "); //int타입의 난수 발생
		}// end for
		System.out.println();
