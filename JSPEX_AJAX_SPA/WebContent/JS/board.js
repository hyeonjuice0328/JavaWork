...
function buildPagination(writePages, totalPage, curPage, pageRows){
  ...
  //■ << 표시 여부
	if(curPage > 1){
  	...
  	//■  < 표시 여부
    if (start_page > 1) 
    	str += "<li><a class='tooltip-top' title='이전'><i class='fas fa-angle-left'></i></a></li>\n";
    ...
    if (totalPage > end_page){
    	str += "<li><a class='tooltip-top' title='다음'><i class='fas fa-angle-right'></i></a></li>\n";
    }

	//■ >> 표시
    if (curPage < totalPage) {
        str += "<li><a class='tooltip-top' title='맨끝'><i class='fas fa-angle-double-right'></i></a></li>\n";
    }
